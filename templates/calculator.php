...
<div class="apc-widget apc-calc" data-widget="calculator">
    ...
    <div class="apc-widget__header">
        ...
        <div class="apc-mode-tabs">
            <button class="apc-tab apc-tab--active" data-tab="price">Price &amp; Route</button>
            <button class="apc-tab" data-tab="route">Route Only</button>
        </div>
    </div>
    ...
    <div class="apc-widget__body">
        ...
        <div class="apc-form">
            ...
            <div class="apc-form__row apc-form__row--submit">
                ...
                <button class="apc-btn apc-btn--secondary apc-advanced-toggle" type="button">⚙ Advanced Settings</button>
            </div>
